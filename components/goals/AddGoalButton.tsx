...
import { GOAL_ICONS } from "@/utils/goals-helpers"; // ← client-safe import
            ...
            <div className="grid grid-cols-6 gap-2">
              {ICONS.map((icon) => (
                <button
                  ...
                  className={`pixel-btn p-2 text-xl flex items-center justify-center transition-colors ${
                    form.icon === icon
                      ? "bg-burning-flame border-abyssal"
                      : "bg-muted hover:bg-oatmeal"
                  }`}
                >
                  {GOAL_ICONS[icon]}
                </button>
