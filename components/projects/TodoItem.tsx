...
import { Check, Trash2, Calendar, Paperclip, Link2, ListChecks } from "lucide-react";
import type { Todo } from "@/db/schema/projects";
import { STATUS_LABELS, STATUS_STYLE, todoProgress } from "@/utils/projects-helpers";
    ...
    <>
      <div className={`flex items-center gap-3 px-3 py-2.5 border-b border-border last:border-0 ${isDone ? "opacity-60" : ""}`}>
        ...
        >
          ...
          {checklist.length > 0 && (
            <div className="h-1 bg-muted border border-border overflow-hidden mt-1.5 max-w-[220px]">
              <div
